 ...
 * @version 1.0
 */
@MessageDriven(name = "TopicSubscriberX", activationConfig = { @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Topic"),
...
public class TopicSubscriberX implements MessageListener {
	private static final Logger LOGGER = LoggerFactory.getLogger(TopicSubscriberX.class);

	@PostConstruct
	public void init() {
		LOGGER.info("TopicSubscriberX initialized...");
	}
